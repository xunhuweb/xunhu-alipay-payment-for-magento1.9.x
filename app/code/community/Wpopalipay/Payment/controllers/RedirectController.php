...
//     }
    ...
    public function indexAction() {
    	...
    	$data=array(
    	    ...
    	    'return_url'=>Mage::getUrl('wpopalipay/redirect/success', array('orderId' => $order_id)),
    ...
    public function successAction() {
        ...
        if ($orderId) {
            ...
            if($order){
                ...
                ->addSuccess(Mage::helper('wpopalipay')->__('Your Payment was Successful!'))
